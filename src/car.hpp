...
public:
   ...
   btRigidBody *wheel3;
   btRigidBody *wheel4;
   btGeneric6DofSpringConstraint *springConst1;
   btGeneric6DofSpringConstraint *springConst2;
   btGeneric6DofSpringConstraint *springConst3;
   btGeneric6DofSpringConstraint *springConst4;
   std::unique_ptr<Model> carModel;
   std::unique_ptr<Model> wheelModel1;
